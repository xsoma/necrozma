...
public:
	...
	bool safe_point(IBasePlayer* entity, Vector eye_pos, Vector aim_point, int hitboxIdx, bool maxdamage);
	...
	void get_hitbox_data(C_Hitbox* rtn, IBasePlayer* ent, int ihitbox, matrix* matrix);


	bool target_can_baimed;
};
