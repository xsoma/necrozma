...
void Drawing::CreateFonts()
{
	...
	LastFontName = "Tahoma";
	interfaces.surfaces->SetFontGlyphSet(fonts::esp_name = interfaces.surfaces->Create_Font(), "Tahoma", 11, 400, 0, 0, FONTFLAG_DROPSHADOW);

	LastFontName = "04B03";
	interfaces.surfaces->SetFontGlyphSet(fonts::weapon_fonts = interfaces.surfaces->Create_Font(), "04B03", 8, 400, 0, 0, FONTFLAG_OUTLINE);

	LastFontName = "Small Fonts";
	interfaces.surfaces->SetFontGlyphSet(fonts::esp_info = interfaces.surfaces->Create_Font(), "Small Fonts", 10, 400, 0, 0, FONTFLAG_OUTLINE);
	...
	LastFontName = "Counter-Strike";
	interfaces.surfaces->SetFontGlyphSet(fonts::esp_icon = interfaces.surfaces->Create_Font(), "Counter-Strike", 28, 500, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);

	LastFontName = "Licuda Console";
	interfaces.surfaces->SetFontGlyphSet(fonts::event_font = interfaces.surfaces->Create_Font(), "Licuda Console", 12, 700, 0, 0, FONTFLAG_DROPSHADOW);
